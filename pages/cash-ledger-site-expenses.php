...
foreach (Db::tableRows('cash_ledger_sites') as $siteRow) {
...
<div class="container pb-5">
    <div class="no-print d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <a href="<?= htmlspecialchars(app_path('pages/cash-ledger-dashboard.php') . '?month=' . urlencode($month), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-primary rounded-pill">
