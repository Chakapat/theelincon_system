...
<div class="container pb-5">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4 mt-2">
        ...
        <a href="<?= htmlspecialchars(app_path('pages/labor-payroll/labor-payroll.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary rounded-pill"><i class="bi bi-arrow-left me-1"></i>กลับบัตรค่าแรง</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="btn-group btn-group-sm shadow-sm">
                                <a class="btn btn-outline-primary" href="<?= htmlspecialchars(app_path('pages/labor-payroll/labor-payroll-archive-view.php') . '?id=' . (int) $r['id'], ENT_QUOTES, 'UTF-8') ?>" title="ดู"><i class="bi bi-eye"></i></a>
                                <a class="btn btn-outline-warning" href="<?= htmlspecialchars(app_path('pages/labor-payroll/labor-payroll-archive-edit.php') . '?id=' . (int) $r['id'], ENT_QUOTES, 'UTF-8') ?>" title="แก้ไข"><i class="bi bi-pencil"></i></a>
                            </div>
