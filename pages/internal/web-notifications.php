...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['mark_read_all'])) {
    if (csrf_verify_request()) {
        ...
        header('Location: ' . app_path('pages/internal/web-notifications.php') . '?read=1');
        exit;
    }
}
        ...
        <div class="list-group list-group-flush">
            ...
            <?php else: ?>
                <?php foreach ($rows as $row): ?>
                    ...
                    ?>
                    <a class="list-group-item list-group-item-action py-3 <?= $isRead ? '' : 'bg-warning-subtle' ?>" href="<?= htmlspecialchars($link !== '' ? $link : app_path('pages/internal/web-notifications.php'), ENT_QUOTES, 'UTF-8') ?>">
