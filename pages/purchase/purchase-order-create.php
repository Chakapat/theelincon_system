...
<div class="container mt-4 mb-5">
    <form action="<?= htmlspecialchars(app_path('actions/action-handler.php')) ?>?action=create_po_direct" method="POST">
        ...
        <div class="row g-3 mb-4 card-soft p-3 mx-0 bg-white">
            ...
            <div class="col-md-4">
                <label class="form-label fw-bold">ผู้ขาย (Supplier) <span class="text-muted fw-normal">(ไม่บังคับ)</span></label>
                <input type="text" id="supplier_search" class="form-control" list="supplier_list" placeholder="พิมพ์ชื่อผู้ขายเพื่อค้นหา (ไม่กรอกได้)">
