    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex align-items-center mb-4">
                <a href="supplier-list.php" class="btn btn-outline-secondary btn-sm rounded-circle me-3">
            ...
            <div class="card form-card p-4 p-md-5">
                <form action="<?= htmlspecialchars(app_path('actions/action-handler.php')) ?>?action=save_supplier" method="POST">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="supplier-list.php" class="btn btn-light px-4 py-2 border">ยกเลิก</a>
