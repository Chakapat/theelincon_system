...
$u = Db::rowByIdField('users', (int) ($report['created_by'] ?? 0), 'userid') ?? [];
$report['recorder_name'] = trim((string) (($u['fname'] ?? '') . ' ' . ($u['lname'] ?? '')));
$report['recorder_code'] = (string) ($u['user_code'] ?? '');
$c = Db::rowByIdField('company', (int) ($report['company_id'] ?? 0)) ?? [];
...
<head>
    ...
    <style>
        ...
        .dsr-photo-wrap img { width: 100%; height: 62mm; display: block; object-fit: contain; background: #fff; }
        ...
        @media print {
            ...
            .dsr-photo-grid { grid-template-columns: repeat(2, 1fr); gap: 8px; }
            .dsr-photo-wrap { break-inside: avoid-page; page-break-inside: avoid; }
            .dsr-photo-wrap img { height: 45mm; max-height: 45mm; }
            .dsr-work-detail-block .row > .col-lg-6 {
                flex: 0 0 auto;
                width: 50%;
                max-width: 50%;
            }
            .dsr-sign-wrap { margin-top: 1.6rem; }
        }
    </style>
</head>
<body class="screen">
...
<div class="container py-4 pb-5">
    ...
    <div class="dsr-print-sheet" id="dsrPrintArea">
        ...
        <div class="dsr-sign-wrap">
            <div class="dsr-sign-box">
                <div class="dsr-sign-line"></div>
                <div class="dsr-sign-label">เซ็นรับทราบ (ผู้รับผิดชอบ)</div>
            </div>
        </div>
    </div>
</div>
