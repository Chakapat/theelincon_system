...
<div class="container py-4 pb-5">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        ...
        <?php if ($isEdit): ?>
            <a href="<?= htmlspecialchars(app_path('pages/daily-site-reports/daily-site-report-view.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= (int) $id ?>" class="btn btn-outline-secondary rounded-pill btn-sm"><i class="bi bi-eye me-1"></i>ดู / พิมพ์</a>
        <?php endif; ?>
    </div>
