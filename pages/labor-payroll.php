...
<div class="container-fluid px-2 px-md-3 pb-5">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3 mt-2">
        <div>
            ...
            <div class="text-muted small">บันทึกการมาทำงานรายวัน ชั่วโมง OT และเบิกล่วงหน้า (คนงาน — ไม่ใช่พนักงาน)</div>
        </div>
    ...
    <div class="punch-card p-2 p-md-3 mb-3">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2">
            ...
            <div class="hint-advance">
                สูตร: ยอดรวม = (วันมา × ค่าแรง/วัน) + (OT รวม × ค่าแรง/8 × 1.5) · ยอดจ่ายจริงรอบนี้หักเบิกล่วงหน้าเฉพาะรอบ 16–สิ้นเดือน
            </div>
        </div>
            ...
            <div class="card border-0 bg-light rounded-3 p-3 mb-3">
                <div class="form-check">
                    ...
                    <label class="form-check-label small" for="closeAndArchive">
                        <strong>ตัดยอดและเก็บประวัติ</strong> — หลังบันทึกจะคัดลอกยอดรอบนี้ไปตารางประวัติ แล้ว <span class="text-danger">ล้างติ๊กมา/OT เฉพาะวันที่ในบัตรรอบนี้</span> (ใช้เมื่อปิดรอบจ่ายแล้ว)
                    </label>
                </div>
            </div>
