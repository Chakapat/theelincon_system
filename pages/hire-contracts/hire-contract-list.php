                    ...
                    <?php foreach ($contracts as $c): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= htmlspecialchars(app_path('pages/hire-contracts/hire-contract-view.php'), ENT_QUOTES, 'UTF-8') ?>?pr_id=<?= $prId ?>" class="btn btn-sm btn-outline-primary" title="ดูรายละเอียด">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?= htmlspecialchars(app_path('pages/purchase/purchase-order-from-pr.php'), ENT_QUOTES, 'UTF-8') ?>?pr_id=<?= $prId ?>" class="btn btn-sm btn-primary" title="ออก PO สั่งจ่าย">
