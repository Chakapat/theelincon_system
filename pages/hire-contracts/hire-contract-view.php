...
if ($prId <= 0) {
    header('Location: ' . app_path('pages/hire-contracts/hire-contract-list.php'));
    exit();
}
...
$pr = Db::findFirst('purchase_requests', static function (array $r) use ($prId): bool {
    return isset($r['id']) && (int) $r['id'] === $prId;
});
if ($pr === null) {
    $pr = [];
}
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3 no-print">
        <h4 class="fw-bold mb-0">
            <a href="<?= htmlspecialchars(app_path('pages/hire-contracts/hire-contract-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-sm btn-outline-secondary me-2" title="กลับรายการสัญญา">
        ...
        <div class="d-flex gap-2">
            ...
            <?php else: ?>
                <a href="<?= htmlspecialchars(app_path('pages/purchase/purchase-order-from-pr.php'), ENT_QUOTES, 'UTF-8') ?>?pr_id=<?= $prId ?>" class="btn btn-primary">ออกใบสั่งจ่าย</a>
            <?php endif; ?>
                    ...
                    <?php foreach ($payments as $p): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center no-print">
                                <?php if ($poId > 0): ?>
                                    <a href="<?= htmlspecialchars(app_path('pages/purchase/purchase-order-view.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= $poId ?>" class="btn btn-sm btn-outline-primary" title="เปิด PO">
