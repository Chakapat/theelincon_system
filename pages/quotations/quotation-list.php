...
<div class="container mt-4 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= htmlspecialchars(app_path('pages/quotations/quotation-create.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-orange px-4 shadow-sm">
                ...
                <tbody>
                    <?php if (count($list_rows) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?= htmlspecialchars(app_path('pages/quotations/quotation-view.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-info" title="ดูรายละเอียด"><i class="bi bi-eye"></i></a>
                                    <a href="<?= htmlspecialchars(app_path('pages/quotations/quotation-edit.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-warning" title="แก้ไข"><i class="bi bi-pencil"></i></a>
                                    <?php if($is_admin): ?>
