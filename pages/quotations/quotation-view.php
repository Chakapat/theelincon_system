...
$q = Db::rowByIdField('quotations', $id);
if (!$q) {
...
$issuer = Db::rowByIdField('users', (int) ($q['created_by'] ?? 0), 'userid') ?? [];
...
<div class="controls-wrapper no-print p-3 text-center bg-dark mb-4">
    ...
    <a href="<?= htmlspecialchars(app_path('pages/quotations/quotation-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-danger btn-sm ms-2">กลับหน้าหลัก</a>
</div>
