...
<div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= htmlspecialchars(app_path('pages/advance-cash/advance-cash-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary rounded-pill px-4">กลับ</a>
    </div>
    ...
    <div class="card form-card p-4">
        <form action="<?= htmlspecialchars(app_path('actions/action-handler.php'), ENT_QUOTES, 'UTF-8') ?>?action=save_advance_cash_request" method="post">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?= htmlspecialchars(app_path('pages/advance-cash/advance-cash-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-light border px-4">ยกเลิก</a>
            </div>
        </form>
    </div>
</div>
