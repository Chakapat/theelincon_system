...
<div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= htmlspecialchars(app_path('pages/advance-cash/advance-cash-view.php') . '?id=' . $id, ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary rounded-pill px-4">กลับรายละเอียด</a>
    </div>
    ...
    <div class="card card-main p-4">
        ...
        <form action="<?= htmlspecialchars(app_path('actions/action-handler.php'), ENT_QUOTES, 'UTF-8') ?>?action=save_advance_cash_receipt&id=<?= (int) $id ?>" method="post" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-12 d-flex gap-2 mt-3">
                ...
                <a href="<?= htmlspecialchars(app_path('pages/advance-cash/advance-cash-view.php') . '?id=' . $id, ENT_QUOTES, 'UTF-8') ?>" class="btn btn-light border px-4">ยกเลิก</a>
            </div>
        </form>
