...
(function () {
    ...
    var ACTION_MESSAGES = {
        ...
        update_po_direct_hire: ['กำลังบันทึก PO สัญญาจ้าง…', DEFAULT_SUB],
        create_hire_contract_po: ['กำลังออก Work Order…', DEFAULT_SUB],
        create_po_from_hire_contract: ['กำลังสร้าง PO สั่งจ่าย…', DEFAULT_SUB],
