...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-outline-secondary rounded-pill" href="<?= htmlspecialchars(app_path('pages/employee-payslip.php'), ENT_QUOTES, 'UTF-8') ?>">กลับหน้าขอสลิป</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <?php if ($status === 'approved'): ?>
                            <a class="btn btn-sm btn-outline-primary" href="<?= htmlspecialchars(app_path('pages/employee-payslip-view.php') . '?request_id=' . (int) ($r['id'] ?? 0), ENT_QUOTES, 'UTF-8') ?>" target="_blank">เปิด PDF</a>
                        <?php else: ?>
