...
if ($po === null) {
    header('Location: ' . app_path('pages/purchase-order-list.php') . '?error=not_found');
    exit();
}
        ...
        <div class="card card-soft p-4 mb-4">
            ...
            <div class="row mt-3 g-3">
                <div class="col-md-6">
                    ...
                    <?php $withholdingType = trim((string) ($po['withholding_type'] ?? 'none')); ?>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="wht_enabled" onchange="calculateTotal()"<?= in_array($withholdingType, ['wht3', 'wht5'], true) ? ' checked' : '' ?>>
