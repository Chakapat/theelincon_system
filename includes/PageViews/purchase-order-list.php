...
<div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= htmlspecialchars(app_path('pages/purchase-order-create.php')) ?>" class="btn btn-primary rounded-pill px-4">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group shadow-sm">
                                ...
                                <a href="<?= htmlspecialchars(app_path('pages/purchase-order-edit.php')) ?>?id=<?= (int)$row['id'] ?>" class="btn btn-sm btn-outline-warning" title="แก้ไขใบสั่งซื้อ">
