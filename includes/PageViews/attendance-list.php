...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST' && isset($_POST['delete_attendance_id'])) {
    ...
    if ($deleteId > 0) {
        Db::deleteRow('attendance_logs', (string) $deleteId);
    }
    header('Location: ' . app_path('pages/attendance-list.php') . '?deleted=1');
    exit;
}
        ...
        <div class="card-body">
            <div class="row g-2">
                ...
                <div class="col-12 d-flex gap-2 justify-content-end mt-2">
                    <a href="<?= htmlspecialchars(app_path('pages/attendance-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary rounded-pill">ล้างตัวกรอง</a>
