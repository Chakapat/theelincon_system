...
if (!in_array($withholdingType, ['none', 'wht3', 'wht5'], true)) {
...
<div class="controls-wrapper no-print p-3 text-center bg-dark shadow-sm mb-4">
    ...
    <a href="po-payment-document.php?id=<?= (int) ($data['id'] ?? 0) ?>&doc=receipt" class="btn btn-outline-info btn-sm ms-2">สร้างใบเสร็จรับเงิน</a>
    <a href="po-payment-document.php?id=<?= (int) ($data['id'] ?? 0) ?>&doc=voucher" class="btn btn-outline-warning btn-sm ms-2">สร้างใบสำคัญจ่าย</a>
            ...
            <div class="col-5">
                <div class="summary-box">
                    ...
                    <div class="summary-item text-danger">
                        <span>หัก ณ ที่จ่าย <?= $withholdingType === 'wht5' ? '5%' : '3%' ?></span>
