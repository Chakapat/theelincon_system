    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            <?php if ($isFinanceRole): ?>
                <?php if ($showAll): ?>
                    <a href="<?= htmlspecialchars(app_path('pages/advance-cash-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-dark rounded-pill px-3">เฉพาะของฉัน</a>
                <?php else: ?>
                    <a href="<?= htmlspecialchars(app_path('pages/advance-cash-list.php') . '?scope=all', ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-dark rounded-pill px-3">ทั้งหมด</a>
                <?php endif; ?>
            <?php endif; ?>
            <a href="<?= htmlspecialchars(app_path('pages/advance-cash-create.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-orange rounded-pill px-4 shadow-sm">
                    ...
                    <?php foreach ($rows as $row): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= htmlspecialchars(app_path('pages/advance-cash-view.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= (int) ($row['id'] ?? 0) ?>" class="btn btn-sm btn-outline-primary">
