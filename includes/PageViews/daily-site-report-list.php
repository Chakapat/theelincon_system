...
<div class="container py-4 pb-5">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="<?= htmlspecialchars(app_path('pages/daily-site-report-calendar.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary fw-semibold rounded-pill shadow-sm">
                <i class="bi bi-calendar3 me-1"></i>มุมมองปฏิทิน
            </a>
            <a href="<?= htmlspecialchars(app_path('pages/daily-site-report-form.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-warning text-dark fw-bold rounded-pill shadow-sm">
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= htmlspecialchars(app_path('pages/daily-site-report-view.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= (int) $r['id'] ?>" class="btn btn-outline-secondary rounded-start-pill" title="ดู / พิมพ์"><i class="bi bi-eye"></i></a>
                                        <a href="<?= htmlspecialchars(app_path('pages/daily-site-report-form.php'), ENT_QUOTES, 'UTF-8') ?>?id=<?= (int) $r['id'] ?>" class="btn btn-outline-warning rounded-end-pill" title="แก้ไข"><i class="bi bi-pencil"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
