...
<div class="container py-4 pb-5" style="max-width: 680px;">
    ...
    <form method="post" action="<?= htmlspecialchars($handler, ENT_QUOTES, 'UTF-8') ?>?action=save_product" class="stock-form-card bg-white p-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?= htmlspecialchars($siteId > 0 ? (app_path('pages/stock-adjust.php') . '?site_id=' . $siteId) : app_path('pages/stock-list.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-secondary rounded-pill">กลับ</a>
        </div>
    </form>
</div>
</body>
