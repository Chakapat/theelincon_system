                ...
                <tr>
                    ...
                    <td class="text-end">
                        <?php if ($status === 'approved'): ?>
                            <a class="btn btn-sm btn-outline-primary" href="<?= htmlspecialchars(app_path('pages/employee-payslip-view.php') . '?request_id=' . (int) ($r['id'] ?? 0), ENT_QUOTES, 'UTF-8') ?>" target="_blank">เปิดสลิป</a>
                        <?php else: ?>
