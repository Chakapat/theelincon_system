        ...
        'hub_home' => [
            ...
            'pages' => [
                'page.index' => [
                    ...
                    'path' => 'index.php',
                    'paths' => ['index.php'],
                    'actions' => ['invoice.edit', 'invoice.delete', 'invoice.cancel'],
                ],
                'page.invoice.create' => [
